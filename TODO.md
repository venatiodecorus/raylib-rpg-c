...
- [ ] Add notes about how assets are processed (spliced in aseprite UI, saved as individual files for props)
...
- [ ] Include github reference to external repo (subrepo?) for raylib (and maybe entt)?
