...
public:
    void testGamestateInitDungeonCreatesRequestedFloors() {
        ...
        g.init_dungeon(biome_t::STONE, 2, 4.0f, 16, 16);
        ...
        for (size_t i = 0; i < g.d.get_floor_count(); i++) {
            ...
            TS_ASSERT_EQUALS(df->get_biome(), biome_t::STONE);
        }
    }
    ...
    void testGamestateInitDungeonDoesNotReinitializeExistingDungeon() {
        ...
        g.init_dungeon(biome_t::STONE, 1, 4.0f, 16, 16);
        ...
        g.init_dungeon(biome_t::STONE, 3, 4.0f, 32, 32);
    ...
    void testGamestateInitDungeonAssignsDistinctValidStairsPerFloor() {
        ...
        for (size_t i = 0; i < g.d.get_floor_count(); i++) {
            ...
            TS_ASSERT_EQUALS(upstairs_tile.get_type(), tiletype_t::UPSTAIRS);
            TS_ASSERT_EQUALS(downstairs_tile.get_type(), tiletype_t::DOWNSTAIRS);
    ...
    void testGamestateInitDungeonCompactMapHasValidSpawnableLocation() {
        gamestate g;
        g.init_dungeon(biome_t::STONE, 1, 4.0f, 8, 8);
    ...
    void testGamestateInitDungeonMakesEachFloorSingleConnectedWalkableRegion() {
        ...
        g.init_dungeon(biome_t::STONE, 4, 4.0f, 16, 16);
    ...
    void testGamestateInitDungeonCompactFloorsKeepStairsConnected() {
        ...
        g.init_dungeon(biome_t::STONE, 3, 4.0f, 8, 8);
